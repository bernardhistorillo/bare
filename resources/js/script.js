import * as underConstructionMethods from './methods/underConstruction';
...
//
//         if (pageConfig[path]) {
//             for (const key in pageConfig[path]) {
//                 this[key] = pageConfig[path][key];
//             }
//         }
//     },
//     mounted() {
...
//             }
//
//             this.modalErrorMessage = content;
...
//                 .then((response) => {
//                     self.subscribeToNewsletterName = "";
//                     self.subscribeToNewsletterEmail = "";
//
//                     self.modalSuccessMessage = "Thanks for subscribing!<br>We’ll keep you posted.";
...
//
//         // ...(() => {
//         //     let route = document.getElementById("route-name").value;
//         //
//         //     if (route === "underConstruction.index") {
//         //         return underConstructionMethods;
//         //     } else {
//         //         return {};
//         //     }
//         // })(),
