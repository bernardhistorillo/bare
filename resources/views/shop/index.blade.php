    ...
    <div class="bg-white py-5">
        <div class="container pt-5">
            ...
            <div class="row justify-content-center pt-4">
                <div class="col-10 col-sm-5 p-xl-4 p-xxl-5 mb-5 mb-sm-4">
                    <a href="{{ route('shop.category', 'nipple-covers') }}#products" class="text-decoration-none">
                ...
                <div class="col-10 col-sm-5 p-xl-4 p-xxl-5 mb-5 mb-sm-4">
                    <a href="{{ route('shop.category', 'flat-nipple-covers-for-men') }}#products" class="text-decoration-none">
                        <div class="w-100 position-relative" style="padding-top:100%">
                ...
                <div class="col-10 col-sm-5 p-xl-4 p-xxl-5 mb-5 mb-sm-4">
                    <a href="{{ route('shop.category', 'travel-pouch') }}#products" class="text-decoration-none">
                        <div class="w-100 position-relative" style="padding-top:100%">
                            <div class="position-absolute background-image-cover w-100 h-100 d-flex align-items-end p-4 p-lg-5" style="top:0; left:0; background-image:url('{{ asset('img/shop/categories/travel-bag.webp') }}')">
