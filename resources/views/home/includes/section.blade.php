    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-sm-10 col-md-9 col-lg-9 col-xl-8 col-xxl-7">
                <p class="text-color-2 cerebri-sans-pro-medium text-center font-size-220 font-size-sm-210 font-size-md-260 font-size-lg-350 font-size-xl-370 font-size-xxl-380 line-height-130 mb-4">Bare is more than a brand;<br> it's a movement.</p>
