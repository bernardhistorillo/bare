...
<div>
    ...
    <div class="bg-color-5 py-5" style="min-height: calc(100vh - 124px)">
        <div class="container pb-5">
            ...
            <div class="d-flex justify-content-end">
                <div class="d-flex align-items-center">
                    <div class="cerebri-sans-pro-regular pe-4">Total Price:&nbsp; <i class="fa-regular fa-peso-sign"></i> <span id="cart-total-price">{{ number_format(Auth::user()->cartTotalPrice(), 2) }}</span></div>
                    <div>
